...
if	[ ! -f Tweaks/Reborn/YouTube.Reborn.v4.2.7.deb ]
then
	echo -e "==> \033[1mYouTube Reborn v4.2.7 is not found. Downloading YouTube Reborn (v4.2.7)...\033[0m"
	curl -L "https://www.dropbox.com/scl/fi/8pezmgmo2h62kalm2yd6l/YouTube.Reborn.v4.2.7.deb?rlkey=jn38a3536id56aa5nhuq76aac&dl=1" --output Tweaks/Reborn/YouTube.Reborn.v4.2.7.deb
else
   	echo -e "==> \033[1mFounded YouTube Reborn (v4.2.7)\033[0m"
fi

# Extract Cercube
	echo -e "==> \033[1mExtracting YouTube Reborn...\033[0m"
if 	(cd Tweaks/Reborn && tar -xf YouTube.Reborn.v4.2.7.deb && tar -xf data.tar.*)
then
...
# Clean up	
	...
	find Tweaks/Reborn -mindepth 1 ! -name "YouTube.Reborn.v4.2.7.deb" ! -name ".gitkeep" -exec rm -rf {} \; 2>/dev/null

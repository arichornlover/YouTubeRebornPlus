...
if	[ ! -f Tweaks/Reborn/YouTube.Reborn.v4.2.3.deb ]
then
	echo -e "==> \033[1mYouTube Reborn v4.2.3 is not found. Downloading YouTube Reborn (v4.2.3)...\033[0m"
	curl -L https://www.dropbox.com/scl/fi/ciejv4ph78e14oh8n5skl/YouTube.Reborn.4.2.3.deb?rlkey=cps2eiybbt6n6grm7vv5be5nm&dl=1 --output Tweaks/Reborn/YouTube.Reborn.v4.2.3.deb
else
   	echo -e "==> \033[1mFounded YouTube Reborn (v4.2.3)\033[0m"
fi

# Extract Cercube
	echo -e "==> \033[1mExtracting YouTube Reborn...\033[0m"
if 	(cd Tweaks/Reborn && tar -xf YouTube.Reborn.v4.2.3.deb && tar -xf data.tar.*)
then
...
# Clean up	
	...
	find Tweaks/Reborn -mindepth 1 ! -name "YouTube.Reborn.v4.2.3.deb" ! -name ".gitkeep" -exec rm -rf {} \; 2>/dev/null

...
# Check Cercube
	if [[ ! -f Tweaks/Cercube/me.alfhaily.cercube_5.3.8_iphoneos-arm.deb ]]
then
    	echo -e "==> \033[1mCercube v5.3.8 is not found. Downloading Cercube (v5.3.8)...\033[0m"
	curl https://apt.alfhaily.me/files/me.alfhaily.cercube_5.3.8_iphoneos-arm.deb --output Tweaks/Cercube/me.alfhaily.cercube_5.3.8_iphoneos-arm.deb
else
    	echo -e "==> \033[1mFounded Cercube (v5.3.8)\033[0m"
	fi

# Extract Cercube
	echo -e "==> \033[1mExtracting Cercube...\033[0m"
	if (cd Tweaks/Cercube && tar -xf me.alfhaily.cercube_5.3.8_iphoneos-arm.deb && tar -xf data.tar.*)
then

...
# Check Cercube
if	[ ! -f Tweaks/Cercube/me.alfhaily.cercube_5.3.13_iphoneos-arm.deb ]
then
	echo -e "==> \033[1mCercube v5.3.13 is not found. Downloading Cercube (v5.3.13)...\033[0m"
	curl https://dl.dropboxusercontent.com/s/3qv0q3v4n96tm28/me.alfhaily.cercube_5.3.13_iphoneos-arm.deb --output Tweaks/Cercube/me.alfhaily.cercube_5.3.13_iphoneos-arm.deb
else
...
if 	(cd Tweaks/Cercube && tar -xf me.alfhaily.cercube_5.3.13_iphoneos-arm.deb && tar -xf data.tar.*)
then
...
# Clean up	
	...
	find Tweaks/Cercube -mindepth 1 ! -name "me.alfhaily.cercube_5.3.13_iphoneos-arm.deb" ! -name ".gitkeep" -exec rm -rf {} \; 2>/dev/null
